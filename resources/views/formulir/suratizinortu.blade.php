...
<li id="tombol">
    <a class="square_btn" href="/formulir/spmempelai">S. Persetujuan Mempelai</a>
</li>
<li id="tombol">
    <a class="square_btn" href="/formulir/skorangtua">S.K. Tentang Orang Tua</a>
</li>
<li id="tombol">
    <a class="square_btn button-clicked" href="/formulir/suratizinortu">Surat Izin Orang Tua</a>
</li>
<li id="tombol">
...
<form action="">
    ...
    <div class="form-row">
        ...
        <p style="margin-top: 20px;"><strong>DATA CALON MENANTU</strong></p>
