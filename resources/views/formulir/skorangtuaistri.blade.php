...
<h1>S.K. Tentang Orang Tua Mempelai Perempuan</h1>
{{-- <a href="#menu-toggle" class="btn btn-secondary" id="menu-toggle">Toggle Menu</a> --}}
<hr>
<form action="/formulir/spkehendaknikah" method="POST">
    {{ csrf_field() }}
    {{ method_field('POST') }}
    ...
    <div class="form-row">
        <div class="form-group col-md-12">
            ...
            <div class="form-line">
                <input type="text" class="form-control" name="nama_ayah" id="nama" placeholder="" value="{{$istri->nama_ayah}}">
            </div>
        </div>
    </div>
