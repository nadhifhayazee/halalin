...
<h1>Surat Keterangan Kematian Suami/Istri</h1>
{{-- <a href="#menu-toggle" class="btn btn-secondary" id="menu-toggle">Toggle Menu</a> --}}
<hr>
<form action="">
    <p><strong>DATA ORANG YANG MENINGGAL</strong></p>
    <div class="form-row">
    ...
    <div class="form-row">
        <div class="form-group col-md-12">
            <label for="job">Pekerjaan Terakhir</label>
            <div class="form-line">
    ...
    <div class="form-row">
        <div class="form-group col-md-12">
            <label for="tglmati">Tanggal Meninggal</label>
            <div class="form-line">
                 <input type="date" class="form-control" id="tglmati" placeholder="">
            </div>   
         </div>
    </div>
    ...
    <div class="form-row">
            <div class="form-group col-md-12">
                <label for="tmpMati">Lokasi Meninggal</label>
                <div class="form-line">
                    <input type="text" class="form-control" id="tmpMati" placeholder="">
                </div>
            </div>
        </div>

    <p style="margin-top: 20px;"><strong>DATA YANG DITINGGAL</strong></p>
    ...
    <div class="form-row">
        ...
        <div class="form-row">
                <div class="form-group col-md-12">
                    <label for="binti">Bin/Binti</label>
                    <div class="form-line">
